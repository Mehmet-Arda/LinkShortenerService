...
namespace LinkShortenerService.Models
{
    public class Users
    {
        ...
        [BsonElement("name"), DisplayName("Adı*"), RegularExpression("^[a-zA-ZıIİoöuüOÖUÜşŞçÇğĞ]+(([',. -][a-zA-ZıIİoöuüOÖUÜşŞçÇğĞ])?[a-zA-ZıIİoöuüOÖUÜşŞçÇğĞ]*)*$", ErrorMessage = "Lütfen geçerli bir isim giriniz."), Required(ErrorMessage = "Adı alanı gereklidir."), MinLength(3, ErrorMessage = "Ad alanı 3 karakterden küçük olamaz."), MaxLength(26, ErrorMessage = "Ad alanı 26 karakterden büyük olamaz.")]
        public string Name { get; set; }

        [BsonElement("surname"), DisplayName("Soyadı*"), RegularExpression("^[a-zA-ZıIİoöuüOÖUÜşŞçÇğĞ]+(([',. -][a-zA-ZıIİoöuüOÖUÜşŞçÇğĞ])?[a-zA-ZıIİoöuüOÖUÜşŞçÇğĞ]*)*$", ErrorMessage = "Lütfen geçerli bir soyad giriniz."), Required(ErrorMessage = "Soyadı alanı gereklidir."), MinLength(3, ErrorMessage = "Soyadı alanı 3 karakterden küçük olamaz."), MaxLength(26, ErrorMessage = "Soyad alanı 26 karakterden büyük olamaz.")]
